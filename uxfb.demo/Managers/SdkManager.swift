...
class SdkManager: NSObject {
    ...
    public var attributesBuilder: UXFBAttributesBuilder = UXFBAttributesBuilder()
    ...
    public func startCampaign(with event: String, attributes: [Attribute]) {
        sdk.theme = theme
        ...
        sdk.startCampaign(eventName: event, attributes: attributes)
    }
